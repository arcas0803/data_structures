...
BenchmarkResult benchmark(
    String name, int iterations, void Function() operation) {
  // Warmup
...
void main() {
  ...
  print(
      '${Colors.dim}Note: Results may vary based on system load and Dart VM state.${Colors.reset}');
  print(
      '${Colors.dim}Run multiple times for more accurate measurements.${Colors.reset}');
}
